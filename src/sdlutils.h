...
namespace SDLUtils
{
   ...
   // Return: width of the texture
   int renderText(const std::string &p_text, const int p_x, const int p_y, const SDL_Color &p_fg, const SDL_Color &p_bg, const T_ALIGN_V p_alignV = T_ALIGN_TOP, const int p_maxWidth = -1, const int p_clipX = 0);
